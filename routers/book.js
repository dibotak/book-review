...
router.get('/review/:id',chechkSession,bookController.seeReview)
// router.post('/review/:id',chechkSession,bookController.reviewPost)
router.get('/review/:id/add',chechkSession,bookController.addreview)
router.post('/review/:id/add',chechkSession,bookController.reviewPost)
